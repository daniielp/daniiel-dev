        ...
        <section>
            <Container maxWidth="lg" className={classes.container}>
                <Grid container spacing={10}>
                    <Grid item md={6}>
                        <Typography variant="h3" component="h2">Brugeraftale</Typography>
                    ...
                    <Grid item md={6}>
                        <Typography variant="h3" component="h2">Privatlivspolitik</Typography>
                    ...
                    <Grid item md={6}>
                        <Typography variant="h3" component="h2">Cookies</Typography>
