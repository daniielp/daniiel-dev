            ...
            <Container maxWidth="lg">
                <Grid container>
                    ...
                    <Grid item md={12} id="tosSearch">
                        ...
                        <BodyText>Daniel Bøgh Pedersen på <Link href="mailto:dp@daniiel.dev" underline="hover">dp@daniiel.dev</Link>.</BodyText>
                        ...
                        <BodyText gutterBottom>Samtykke til tracking via cookies (samtykke indhentes via pop-up på Tjenesten), jf. § 4 om samtykke i Bekendtgørelse 2011-12-09 nr. 1148 om krav til information og samtykke ved lagring af eller adgang til oplysninger i slutbrugeres terminaludstyr. Du kan når som helst tilbagekalde samtykket til behandling af tracking og cookies ved at slette cookies i dit system som beskrevet i vores cookie-politik, som du finder <Link href="/policies/cookies" underline="hover">her</Link>.</BodyText>
                        ...
                        <BodyText>Hvis du vil udnytte dine rettigheder, som er oplistet nedenfor, beder vi dig skrive en e-mail til: <Link href="mailto:dp@daniiel.dev" underline="hover">dp@daniiel.dev</Link>*</BodyText>
