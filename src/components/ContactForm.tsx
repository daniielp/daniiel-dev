      ...
      <Box sx={{ bgcolor: 'secondary.main', height: '100%', p: 2 }}>
        <Box component="form" sx={{ width: '100%;', display: 'flex', flexDirection: 'column' }} onSubmit={handleSubmit}>
          <TextField
            ...
            InputLabelProps={{ htmlFor: "name-" + randomNumber }}
            fullWidth={true}
            label="Navn"
            variant="outlined"
            required
          ...
          <TextField
            ...
            InputLabelProps={{ htmlFor: "email-" + randomNumber }}
            fullWidth={true}
            type="email"
            label="Email"
            variant="outlined"
          ...
          <TextField
            ...
            InputLabelProps={{ htmlFor: "subject-" + randomNumber }}
            fullWidth={true}
            label="Emne"
            variant="outlined"
            required
          ...
          <TextField
            ...
            InputLabelProps={{ htmlFor: "message-" + randomNumber }}
            fullWidth={true}
            label="Besked"
            multiline
            variant="outlined"
