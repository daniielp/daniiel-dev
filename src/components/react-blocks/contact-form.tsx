    ...
    <div className="pb-10 pt-10 sm:pb-16 sm:pt-16 lg:overflow-hidden lg:pb-14 lg:pt-8">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:gap-8">
          <div className="flex flex-col gap-8 md:px-6 lg:px-0">
            <h1 className="text-4xl font-bold tracking-tight text-slate-900">Let's get in touch</h1>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Please double-check that the email address you've entered matches the one
                        you use in your email client. This ensures you'll receive our messages
                        without any issues.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="Greeting">Just saying hi!</SelectItem>
                          <SelectItem value="Job Offer">Job offer</SelectItem>
                          <SelectItem value="project offer">Project offer</SelectItem>
          ...
          <div className="flex items-center justify-center sm:-mb-48 lg:relative lg:m-0">
            <Card className="flex h-full w-full flex-col">
              <CardHeader>
                ...
                <CardDescription>
                  Below you can see an example of how the email will look.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-1 bg-slate-50">
                <p className="py-2">
                  <span className="font-semibold">From</span>: {form.watch("name")}{" "}
                  <span
                    className={cn(form.watch("email") ? "inline-flex" : "hidden")}
                  >{`<${form.watch("email")}>`}</span>
                </p>
                <Separator />
                <p className="py-2">
                  <span className="font-semibold">Subject</span>: {form.watch("category")}{" "}
                  <span className={cn(form.watch("category") ? "inline-flex" : "hidden")}>
                    - Request from daniiel.dev
                  </span>
                </p>
                <Separator />
