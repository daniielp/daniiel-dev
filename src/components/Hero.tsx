...
const tabs = [
  { name: 'location.config.tsx', isActive: true },
  ...
  return (
    <div className="overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.5rem] dark:pb-32 dark:pt-[4.5rem] dark:lg:mt-[-4.75rem] dark:lg:pt-[4.75rem]">
      <div className="py-16 sm:px-2 lg:relative lg:py-20 lg:px-0">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-y-16 gap-x-8 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16">
          <div className="relative z-10 md:text-center lg:text-left">
            <Image
              className="absolute bottom-full right-full -mr-72 -mb-56 opacity-50 pointer-events-none"
              src={blurCyanImage}
              alt=""
              width={530}
              height={530}
            ...
            <div className="relative">
              ...
              UI/UX Designer og Developer, baseret i Aarhus.
              </p>
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/" className={""}>Get started</Button>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              />
              <Image
                className="absolute -bottom-40 -right-44 pointer-events-none"
                src={blurIndigoImage}
                alt=""
                width={567}
                height={567}
