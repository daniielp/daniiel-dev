...
import { ChevronDownIcon, InboxIcon, NewspaperIcon, QuestionMarkCircleIcon } from '@heroicons/react/20/solid'
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  <a href="/#projects" onClick={togglePopup} className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                    ...
                    <span className="ml-3 text-base font-medium text-gray-900">Projecter</span>
